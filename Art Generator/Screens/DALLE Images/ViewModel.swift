        ...
        if let selectedImage {
            ...
            Task {
                do {
                    ...
                    let response = try await apiService.getVariariations(formDataField: formdataFields, fieldName: "image", fileName: "Selected Image", fileData: imageData)
                    ...
                    func listFonts(forFamilyNames familyNames: [String]) {
                    ...
                    // Usage:
                    listFonts(forFamilyNames: ["Poppins", "Fredoka One"])
